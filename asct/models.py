...
class ServerInfo(models.Model):
    ...
    role = models.CharField(max_length=3, choices=role_choices, null=False, default='other') # e.g., web server, db server
...
class NetworkUsage(models.Model):
    ...
    network_local_1 = models.CharField(max_length=1, choices=network_type, default='10G', null=False)
    network_local_1_inbound = models.DecimalField(max_digits=12, decimal_places=2, null=False)
    network_local_1_outbound = models.DecimalField(max_digits=12, decimal_places=2, null=False)
    
    network_local_2 = models.CharField(max_length=1, choices=network_type, default='10G', null=True, blank=True)
    network_local_2_inbound = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
    network_local_2_outbound = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
    
    network_nas_1 = models.CharField(max_length=1, choices=network_type, default='10G', null=True, blank=True)
    network_nas_1_inbound = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
    network_nas_1_outbound = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
    
    network_nas_2 = models.CharField(max_length=1, choices=network_type, default='10G', null=True, blank=True)
    network_nas_2_inbound = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
    network_nas_2_outbound = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
    
    network_san_1 = models.CharField(max_length=1, choices=network_type, default='16G', null=True, blank=True)
    network_san_1_inbound = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
    network_san_1_outbound = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
    
    network_san_2 = models.CharField(max_length=1, choices=network_type, default='16G', null=True, blank=True)
    network_san_2_inbound = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
    network_san_2_outbound = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
    
    network_mgmt_1 = models.CharField(max_length=1, choices=network_type, default='1G', null=False)
    network_mgmt_2 = models.CharField(max_length=1, choices=network_type, default='1G', null=True, blank=True)
...
class SystemLog(models.Model):
    ...
    log_level = models.CharField(max_length=1, choices=log_level_choices, null=False, default='ERROR')
